        ...
        if choice < 9 and choice > 0:
            ...
            if choice == 1:
                ...
                if empty(tasks):
                    ...
                    print("\n😔💔 Sorry, You Don't Have Any Tasks 😭📭")
                ...
                if empty(tasks):
                    ...
                    if task_done in tasks:
                        ...
                        if task_done.isdigit():
                            print(
                                f"❌🆔 ID({task_done}) "
                                f"This ID Isn't In Your Tasks 😭"
                            )
                        else:
                            print(
                                f"❌ {task_done} Isn't a Number?? 🤨🤔"
                            )
                ...
                if empty(tasks):
                    ...
                    num_of_del = input(
                        "🗑️🔥 Enter The Number Of Task To Delete\nBy ID: "
                    ).strip()
                    ...
                    if num_of_del.isdigit():
                        ...
                        if num_of_del in tasks:
                            ...
                            print(
                                f"❌🆔 {num_of_del} Is Out Of The Range.... 😭"
                            )

                    else:
                        print(
                            f"❌ {num_of_del} That Isn't A Number.... 🤨"
                        )
                ...
                if n == 0 and len(tasks) == 0:
                    print("📊 Completing Rate (0%) 😭")

                else:
                    print(
                        "📈 Completing Rate ({})".format(
                            (n / len(tasks)) * 100
                        )
                    )
                ...
                time.sleep(2)
                print("🧹🔥 Now You Don't Have Any Tasks 😭📭")
                tasks.clear()
